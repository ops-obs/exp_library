...
AliasMatch ^/manual(?:/(?:da|de|en|es|fr|ja|ko|pt-br|ru|tr|zh-cn))?(/.*)?$ "/home/observer/exp_library/build/mod-wsgi-httpd/build/httpd/manual$1"

<Directory "/home/observer/exp_library/build/mod-wsgi-httpd/build/httpd/manual">
    Options Indexes
    AllowOverride None
    Require all granted
